# v2.51 Dual Momentum with Out Days  by Vladimir


import numpy as np
# ----------------------------------------------------------
STOCKS = ['QQQ', 'SPY']; BONDS = ['TLT', 'IEF']; 
VOLA = 126; BASE_RET = 83; RET = 252; EXCL = 21; LEV = 1.00; 
# ----------------------------------------------------------

class DualMomentumWithOutDays(QCAlgorithm):
    ...
    def Initialize(self):
        ...
        self.BND2 = self.AddEquity('IEF', Resolution.Minute).Symbol
        ...
        self.real_wt = {}
        self.mkt = []
        self.SetWarmUp(VOLA, Resolution.Daily)
