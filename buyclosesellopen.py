...
class SimpleML(QCAlgorithm):
    ...
    def Initialize(self):
        ...
        self.Schedule.On(self.DateRules.WeekStart(), self.TimeRules.BeforeMarketClose('AMZN', 10), 
        Action(self.create_model))
        self.Schedule.On(self.DateRules.EveryDay(), self.TimeRules.AfterMarketOpen('AMZN', 1), 
        Action(self.trade))
